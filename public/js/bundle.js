...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //  Add group
...
var stripe = Stripe('pk_test_maiinVm4AfPODTPVumO94t8p00H3tPM02q');
...
var bookBtn = document.getElementById('book-tour'); // Values Form 
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "8445" + '/');
